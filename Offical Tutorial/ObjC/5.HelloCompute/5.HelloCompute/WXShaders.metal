...
fragment float4 samplingShader(RasterizerData in [[stage_in]],
                               texture2d<half> colorTexture [[ texture(WXTextureIndexOutPut) ]])
{
...
kernel void
grayscaleKernel(texture2d<half, access::read>  inTexture  [[texture(WXTextureIndexInput)]],
                texture2d<half, access::write> outTexture [[texture(WXTextureIndexOutPut)]],
